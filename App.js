  ...
  return (
    <View style={{ flexDirection: 'column', alignSelf: 'center', columnGap: 20 }}>
      <View style={{ marginBottom: 20, marginTop: 20 }}>
        {isOn ? (
          <Image source={require('./assets/src/lights-Off.jpg')} style={{ height: 400, width: 300 }} />
        ) : (
          <Image source={require('./assets/src/lights-On.jpg')} style={{ height: 400, width: 200 }} />
        )}
      </View>
...
const Counter = ({ onBackPress }) => {
  ...
  return (
    <View>
      ...
      <View style={{ flexDirection: 'row', height: 60, width: 70, gap: 100 }}>
